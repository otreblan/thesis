...
\begin{enumerate}
	...
	\item A private EnTT registry is attached as a component to the simulation entity.
	\item The electric sources are attached to new entities in the private registry.
	\item The simulation iterates for a determined number of timesteps.
	\item The private registry and all it's contents are deleted.
