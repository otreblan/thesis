...
\begin{figure}[H]
	...
	\begin{tikzpicture}[
		...
		\graph[layered layout, components go right top aligned, nodes=draw, edges=rounded corners, sibling distance=1cm]{
			Frontends -> "Backends*\{f16,f32,f64\}" -> "Basic services";

			{[same layer] Frontends, GUI, CLI};
			{[same layer] "Backends*\{f16,f32,f64\}", "CPU Sequential", "CPU Parallel", "Vulkan"};
	...
	\label{fig:fdtd_lucuma_service_graph2}
\end{figure}
