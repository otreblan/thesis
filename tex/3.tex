...
Mainlly for to store the simulation metadata and objects as \emph{components} related to \emph{entities} inside a EnTT registry.
This approach allows for each service (\emph{system}), to iterate over the data in a cache friendly way.
